...

{
  ...
  components = {
    ...
    "citybikes" =
      ps: with ps; [
      ]; # missing inputs: python-citybikes
    "clementine" =
      ps: with ps; [
    ...
    "lunatone" =
      ps: with ps; [
      ]; # missing inputs: lunatone-rest-api-client
    "lupusec" =
      ps: with ps; [
        lupupy
      ];
    ...
    "sunricher_dali_center" =
      ps: with ps; [
      ]; # missing inputs: PySrDaliGateway
    "sunweg" =
      ps: with ps; [
      ];
    "supervisord" =
